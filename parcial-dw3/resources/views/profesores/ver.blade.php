...
<head>
    ...
    <title>Visualización de Profesores</title>
...
<header class="p-4 fixed-top bg-light">
    <h2 class="text-center">Visualización de Profesores</h2>
</header>
...
<body>
    <div class="container p-4" style="margin-top: 100px;">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center font-weight-bold">Detalles específicos del profesor</div>
                    ...
                    <form method="post" action="{{route('actualizar',['id'=>$profesores->id])}}">
                            ...
                            <div class="container text-center pt-4">
                                <a href="{{url('profesores/index') }}" class="btn btn-primary">Volver</a>
                            </div>
                        </form>
                    </div>
                </div>
